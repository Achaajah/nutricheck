...
export default function InformasiPage() {
  ...
  const nutrisi = [
    { nama: "Karbohidrat", icon: "🌾", deskripsi: "Sumber energi utama yang digunakan tubuh untuk beraktivitas" },
    { nama: "Protein", icon: "🥩", deskripsi: "Membantu pembentukan dan perbaikan jaringan tubuh." },
    { nama: "Lemak", icon: "🥑", deskripsi: "Cadangan energi dan membantu penyerapan vitamin" },
    { nama: "Serat", icon: "🥦", deskripsi: "Membantu menjaga kesehatan sistem pencernaan." },
  ];
